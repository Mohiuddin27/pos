...
<style>
    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <h1 class="h3 mb-3"><strong>Product Category</h1>
                                    ...
                                    <div class="card-header">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div>
                                                ...
                                                <a href="#productCategory-modal" data-bs-toggle="modal"
                                                    class="btn btn-primary btn-sm mb-3"><i class="fa fa-plus-circle"
                                                        aria-hidden="true"></i> Add New Product Category</a>
                                                {{-- @endif --}}
                                            </div>
                                        </div>
                                       <br>
                                                            ...
                                                            <div class="dropdown partyy text-center">
                                                                ...
                                                                <ul class="dropdown-menu" style="text-align: center" aria-labelledby="dropdownMenuButton1">
                                                                  <li>  <a class="btn btn-warning btn-sm dropdown-item text-center" edit_id="{{ $data->id }}"
                                                                    data-bs-toggle="modal" id="edit_product_category"><i
                                                                        class="fa fa-pencil-square-o  text-dark"
                                                                        style="font-size:20px" aria-hidden="true"> Edit</i>
                                                                </a></li>
                                                                  <li> <a class="btn btn-light btn-sm dropdown-item text-center" id="delete_product_category"
            ...
            <div id="productCategory-modal" class="modal fade">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mess"></div>
                            <form id="add_product_category_form" action="" method="POST">
                                @csrf
                                <div class="form-group">
                                    <label for="" class="mb-2">Product Category name</label>
            ...
            {{-- //edit party type --}}
            <div id="editProductCategory-modal" class="modal fade">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
...
<script>
    ...
    $(document).on('submit', 'form#add_product_category_form', function(e) {
        e.preventDefault();
        var name = $("#name").val();
        var fd = new FormData();
        fd.append('name',name);
    ...
    $(document).on('click', '#edit_product_category', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#editProductCategory-modal input[id="edit_id"]').val(data.id);
                $('#editProductCategory-modal input[id="edit_name"]').val(data.name);
                $('#editProductCategory-modal select[id="edit_status"]').val(data.status);


                $('#editProductCategory-modal').modal('show');
            }
        })
    });
   ...
   $(document).on('submit', 'form#updateData', function(e) {
    ...
    $(document).on('click', 'a#delete_product_category', function(e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: 'product-category-temporary-delete/' + id,
                    success: function(data) {
                        Swal.fire(
                            'Delete',
